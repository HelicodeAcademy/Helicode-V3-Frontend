                ...
                <div className="max-w-7xl mx-auto">
                    <div className="relative flex items-center justify-between h-17 px-4 md:px-8">
                        ...
                        <div className="hidden lg:flex items-center gap-8 wfull h-full justifycenter">
                            ...
                            <Link href="/about" className="px2 text-black/70 font-medium hover:text-black transition-colors">
                                About
                            </Link>

                            <Link href="/blog" className="px2 text-black/70 font-medium hover:text-black transition-colors">
                                Hire Talent
                            </Link>
                        </div>
