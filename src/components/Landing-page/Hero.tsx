        ...
        <div className="flex flex-col gap-10 justify-center items-center text-center max-w-4xl mx-auto">
          <div className="space-y-4">
            ...
            <p className="max-w-xl mx-auto text-lg sm:text-xl md:text-2xl text-[#717171] font-medium">
              Ambitious teams use our system to automate hiring, payroll,
              compliance, and IT processes in one place.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button className="text-[#363636] bg-[#E9E9E9] hover:bg-[#E9E9E9]/90 rounded-[6px]">
              Book a Demo
            </Button>
          </div>
        </div>
