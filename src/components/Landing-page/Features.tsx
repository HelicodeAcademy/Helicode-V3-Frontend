      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col gap-12">
          <div className="flexgap-4flex-colmd:flex-rowmd:items-end max-w-xl">
            <h2 className="font-bold text-3xl sm:text5xl sm:text-[44px] leading-tight">
          ...
          <div className="space-y-6 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-6">
              <div className="flex flex-col rounded-lg bg-white border border-[#E6E8EC] p-5 md:p-8 space-y-8 overflow-hidden">
                ...
                <div className="space-y-2.5">
                  ...
                  <p className="text-[#697282] font-normal text-base">
                    Onboard new hires in minutes. Manage contracts, documents,
                    roles, and employee records from one dashboard.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-[#E6E8EC] p-5 md:p-8 space-y-8 rounded-lg flex flex-col overflow-hidden   flex1h105">
                <div className="flex items-center justify-center w-full py-6 md:py10">
                  <div className="relative w-full max-w[420px] max-w105 bg-amber100 max-w-md h-45 h[180px] md:h-55 md:h[220px] flex flex-col items-center justify-center">
                    <div className="bg-white w-75 wfull flex items-center justify-between py-2.5 px-3 p4 rounded-lg border border-[#E6E8EC] shadow-[0_4px_10px_-5px_rgba(0,0,0,0.10)]">
                      ...
                      <div className="bg-[#E3ECFF] flex items-center gap-1 px-1 py-0.5 rounded-full ml-auto">
                        ...
                        <span className="font-normal text-xs text-[#0052FF]">
                          Hired
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="p-1.5 border border-[#E6E8EC] rounded-full">
                        <Image
                          src="/landingpage/Netherlands.svg"
                          alt="Botswana-Flag"
                          width={26}
                          height={26}
                          className="h-full w-full"
                ...
                <div className="space-y-2.5">
                  ...
                  <p className="text-[#697282] font-normal text-base">
                    Hire full-time employees or contractors across Africa with
                    locally compliant contracts without setting up entities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1.2fr] gap-6">
              ...
              <div className="flex flex-col rounded-lg bg-white border border-[#E6E8EC] p-5 md:p-8 space-y-8 overflow-hidden">
                ...
                <div className="space-y-2.5">
                  <h3 className="font-bold text-lg md:text-2xl">Compliance</h3>

                  <p className="text-[#697282] font-normal text-base">
                    We handle local labor laws, tax requirements, and regulatory
