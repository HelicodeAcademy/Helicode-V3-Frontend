                ...
                {testimonials.map((testimonial, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      data-card
                      className={`shrink-0 snap-start basis-[90%] sm:basis-[70%] md:basis-[48%] lg:basis-[32%]   hfull self-stretch flex ${isBlurred ? "blur-sm opacity70" : ""}`}
                    >
                      <div
                      ...
                      >
                        <div
                          className="absolute bottom-0 left-0 w-3 h-3 border-l-[3px] border-b-[3px] border-(--border-bg) border-l-[#0052FF]border-[#0052FF]"
                        ...
                        <div className="bg-[#F8F8F8] relative flex grow flex-col gap-10 p-6   w-full h-full">
                          ...
                          <div>
                            <p className="text-[#697282] font-normal text-sm">
                              {testimonial.role}
                            </p>
