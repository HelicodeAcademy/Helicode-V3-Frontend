          ...
          <div className="space-y-18">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl">
                ...
                excessive fees. Stablecoins eliminate unnecessary intermediaries
                and create a neutral, programmable layer for global payments.
              </p>
            </div>

            <div className="space-y-4">
              <h1 className="text-xl md:text-3xl font-medium">Contact Us</h1>
              <p className="text-xl">fiyin@helicode.xyz</p>
            </div>
          </div>
        </div>
        <FooterCTA />
