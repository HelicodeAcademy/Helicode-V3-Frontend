        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 pb-10">
          <div className="space-y-13">
            ...
            <div className="space-y-18">
              <div>
                <h2 className="text-xl md:text-3xl font-medium text-black mb-3">
                ...
                <p className="mb-4 text-xl">
                  When you use Helicode, we may collect:
                </p>
                ...
                <ul className="list-disc pl-4 mb-16 space-y-2.5 text-xl">
                  ...
                  <li>
                    Any information you submit through forms, onboarding flows,
              ...
              <div>
                ...
                <ul className="list-disc pl-4 mb-4 space-y-2.5 text-xl">
                  ...
                  <li>
                    Communicate with you (updates, support, product information)
                  </li>
              ...
              <div>
                <h2 className="text-xl md:text-3xl font-medium text-black mb-8">
                  Stablecoins and Financial Data
                </h2>
                <p className="font-normal text-xl text-black mb-6">
                  Some Helicode services involve stablecoin payments and
                  blockchain-based infrastructure.
                </p>

                <ul className="list-disc pl-4 mb-4 space-y-2.5 text-xl">
                  <li>
                    Transaction data recorded on public blockchains is public by
                    nature and not controlled by Helicode.
                  </li>
                  <li>We do not control or modify blockchain records.</li>
                  <li>
                    We only collect off-chain data required to operate our
                    services, meet compliance requirements, and support users.
                  </li>
                </ul>

                <p className="font-normal text-xl text-black mb8">
                  You acknowledge and accept the transparency and immutability
                  of blockchain transactions when using these services.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-4 mb4 space-y-2.5 text-xl">
                  ...
                  <li>
                    To protect Helicode, our users, or the public from harm or
                    fraud
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h2 className="text-xl md:text-3xl font-medium text-black mb-6">
                  How We Share Information
                </h2>
                ...
                <p className="font-normal text-xl text-black mb6">
                  ...
                  infrastructure. However, no system is 100% secure, and we
              ...
              <div>
                ...
                <p className="font-normal text-xl text-black mb8">
                  ...
                  <a
                    href="mailto:admin@helicode.xyz"
              ...
              <div>
                ...
                <p className="font-normal text-xl text-black mb6">
                  Helicode is not intended for individuals under the age of 18.
              ...
              <div>
                ...
                <p className="font-normal text-xl text-black mb6">
                  ...
                  do, we will update the “Last updated” date and notify users
                  where required. Continued use of our Services means you accept
                  the updated policy.
                </p>
              </div>
